...
import {
    cUpdateSigningAuthorityEnumeration,
...
export class MspDirectUpdateSigningAuthorityEditComponent
    ...
    administeringForOptions =
        cUpdateSigningAuthorityEnumeration.administeringFor.edit;
    ...
    private createArrayForm() {
        const form = this.fb.group({
            forIdentifyEmailAddress: [
                null,
                cUpdateSigningAuthorityValidator.edit.forIdentifyEmailAddress,
            ],
            forIdentifyMinistryUserId: [
                null,
                cUpdateSigningAuthorityValidator.edit.forIdentifyMinistryUserId,
            ],
            ...
            formGroupEmail: this.fb.group(
                {
                    emailAddress: [
                        null,
                        cUpdateSigningAuthorityValidator.edit.emailAddress,
                    ],
                    confirmEmail: [
                        null,
                        cUpdateSigningAuthorityValidator.edit.confirmEmail,
                    ],
                },
                {
            ...
            administeringFor: [
                null,
                cUpdateSigningAuthorityValidator.edit.administeringFor,
            ],
    ...
    patchValue(formGroup) {
        ...
        formGroup.patchValue(
            RandomObjects.getUser((this.getFormsCount + 1).toString() + 'SA')
        );
    }
}
