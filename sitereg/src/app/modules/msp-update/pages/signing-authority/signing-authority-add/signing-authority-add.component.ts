...
export class MspDirectUpdateSigningAuthorityAddComponent
    ...
    administeringForOptions =
        cUpdateSigningAuthorityEnumeration.administeringFor.add;
    radioBtnLabels = [
    ...
    private createArrayForm() {
        const form = this.fb.group({
            ...
            formGroupEmail: this.fb.group(
                {
                    emailAddress: [
                        null,
                        cUpdateSigningAuthorityValidator.add.emailAddress,
                    ],
                    confirmEmail: [
                        null,
                        cUpdateSigningAuthorityValidator.add.confirmEmail,
                    ],
                },
                {
            ...
            administeringFor: [
                null,
                cUpdateSigningAuthorityValidator.add.administeringFor,
            ],
        });
    ...
    patchValue(formGroup) {
        ...
        formGroup.patchValue(
            RandomObjects.getUser02((this.getFormsCount + 1).toString() + 'SA')
        );
    }
}
