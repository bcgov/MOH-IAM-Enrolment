...
export class MspDirectUpdateRequestorComponent
    ...
    createForm(): FormGroup {
        const form = this.fb.group({
            organizationNumber: [
                '',
                cUpdateValidators.requestorInformation.organizationNumber,
            ],
            emailAddress: [
                '',
                cUpdateValidators.requestorInformation.emailAddress,
            ],
        });
    ...
    patchValue(formGroup) {
        ...
        formGroup.patchValue(
            RandomObjects.getRequestor('RequestorInformation')
        );
    }
}
