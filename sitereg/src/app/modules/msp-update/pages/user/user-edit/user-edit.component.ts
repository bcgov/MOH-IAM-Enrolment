...
export class MspDirectUpdateUserEditComponent implements OnInit, IDataForm {
    ...
    private createArrayForm() {
        const form = this.fb.group({
            forIdentifyEmailAddress: [
                null,
                cUpdateUserValidator.edit.forIdentifyEmailAddress,
            ],
            forIdentifyMinistryUserId: [
                null,
                cUpdateUserValidator.edit.forIdentifyMinistryUserId,
            ],
            ...
            administeringFor: [
                null,
                cUpdateUserValidator.edit.administeringFor,
            ],
            changeAdministerFor: [
                null,
                cUpdateUserValidator.edit.changeAdministeringFor,
            ],
            changeRole: [
                this.changeRoleOptions[0],
                cUpdateUserValidator.edit.changeRole,
            ],
        });
    ...
    patchValue(formGroup) {
        ...
        formGroup.patchValue(
            RandomObjects.getUser((this.getFormsCount + 1).toString() + 'USR')
        );
    }
}
